        ...
        Column(
            ...
            Card(
                ...
                colors = CardDefaults.cardColors(
                    containerColor = if (selectedType == "PATTERN")
                        ProLockerPrimary.copy(alpha = 0.15f)
                    else MaterialTheme.colorScheme.surfaceVariant
                ),
                shape = RoundedCornerShape(20.dp),
                border = if (selectedType == "PATTERN")
                    BorderStroke(2.dp, ProLockerPrimary)
                else null,
                ...
                Row(
                    ...
                    Icon(
                        ...
                        tint = if (selectedType == "PATTERN") ProLockerPrimary
                    ...
                    Column {
                        Text(
                            ...
                            style = MaterialTheme.typography.titleLarge,
                            fontWeight = FontWeight.Bold,
                            color = if (selectedType == "PATTERN") ProLockerPrimary
                            else MaterialTheme.colorScheme.onSurface
                        )
                        Text(
                            stringResource(R.string.draw_secure_pattern),
                            style = MaterialTheme.typography.bodyMedium,
                            color = if (selectedType == "PATTERN")
                                ProLockerPrimary.copy(alpha = 0.7f)
            ...
            Card(
                ...
                colors = CardDefaults.cardColors(
                    containerColor = if (selectedType == "PIN")
                        ProLockerPrimary.copy(alpha = 0.15f)
                    else MaterialTheme.colorScheme.surfaceVariant
                ),
                shape = RoundedCornerShape(20.dp),
                border = if (selectedType == "PIN")
                    BorderStroke(2.dp, ProLockerPrimary)
                else null,
                elevation = CardDefaults.cardElevation(
                ...
                Row(
                    ...
                    Icon(
                        ...
                        tint = if (selectedType == "PIN") ProLockerPrimary
                        else MaterialTheme.colorScheme.onSurface,
                        modifier = Modifier.size(48.dp)
                    )
                    Spacer(modifier = Modifier.width(16.dp))
                    Column {
                        Text(
                            ...
                            style = MaterialTheme.typography.titleLarge,
                            fontWeight = FontWeight.Bold,
                            color = if (selectedType == "PIN") ProLockerPrimary
                            else MaterialTheme.colorScheme.onSurface
                        )
                        Text(
                            stringResource(R.string.enter_numeric_pin),
                            style = MaterialTheme.typography.bodyMedium,
                            color = if (selectedType == "PIN")
                                ProLockerPrimary.copy(alpha = 0.7f)
                            else MaterialTheme.colorScheme.onSurface.copy(alpha = 0.7f)
                        )
                    }
